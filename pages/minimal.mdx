...
Creates an Minimal application. The minimal() function is a top-level function exported by the minimal module.
...
### minimal.json([options])

This is a built-in middleware function in Minimal. It parses incoming requests with JSON payloads and is based on body-parser.
...
### minimal.urlencoded([options])

This is a built-in middleware function in Minimal. It parses incoming requests with urlencoded payloads and is based on body-parser.
